...
RVS.LIB.QS = {
	...
	buttons:[
		// NEW BUTTONS
		{showsize:"half",fs:15, fw:"500", ff:"Roboto", lh:32, pd:["0px","20px","0px","20px"],  bg:"rgba(255,255,255,1)", color:"#000000", content:"Click Here", cls:"rev-btn", hc:"rgba(255,255,255,1)", hbg:"#000000", hs:300, ease:"Power3.easeInOut"},
		{showsize:"half",fs:15, fw:"500", ff:"Roboto", lh:32, pd:["0px","20px","0px","20px"],  br:["16px", "16px", "16px", "16px"], bg:"rgba(255,255,255,1)", color:"#000000", content:"Click Here", cls:"rev-btn", hc:"rgba(255,255,255,1)", hbg:"#000000", hs:300,ease:"Power3.easeInOut"},

		{showsize:"half",fs:20, fw:"500", ff:"Roboto", lh:50, pd:["0px","20px","0px","20px"],  bg:"rgba(0,0,0,1)", color:"#ffffff", content:"Click Here", cls:"rev-btn", hc:"rgba(0,0,0,1)", hbg:"#ffffff", hs:200,ease:"Power1.easeInOut"},
		{showsize:"half",fs:20, fw:"500", ff:"Roboto", lh:50, pd:["0px","20px","0px","20px"],  br:["25px", "25px", "25px", "25px"], bg:"rgba(0,0,0,1)", color:"#ffffff", content:"Click Here", cls:"rev-btn", hc:"rgba(0,0,0,1)", hbg:"#ffffff", hs:200,ease:"Power1.easeInOut"},

		{showsize:"half",fs:17, fw:"500", ff:"Roboto", lh:40, pd:["0px","25px","0px","25px"],  bg:"rgba(0,0,0,0)", bw:["1px","1px","1px","1px"], bs:"solid", bc:"rgba(255,255,255,0.35)", color:"#ffffff", content:"Click Here", cls:"rev-btn", hbc:"rgba(255,255,255,0.75)", hc:"rgba(255,255,255,1)", hs:300,ease:"Power1.easeInOut"},
		{showsize:"half",fs:17, fw:"500", ff:"Roboto", lh:40, pd:["0px","25px","0px","25px"],  br:["25px", "25px", "25px", "25px"], bw:["1px","1px","1px","1px"], bs:"solid", bc:"rgba(255,255,255,0.35)",  bg:"rgba(0,0,0,0)", color:"#ffffff", content:"Click Here", cls:"rev-btn", hbc:"rgba(255,255,255,0.75)",hc:"rgba(255,255,255,1)",  hs:300,ease:"Power1.easeInOut"},


		{showsize:"half",fs:17, fw:"500", ff:"Roboto", lh:40, pd:["0px","25px","0px","25px"],  bg:"#007aff",  color:"#ffffff", 									    content:"Click Here", cls:"rev-btn", hs:300, hc:"#ffffff", hbg:"#007aff", hfb:"120%", hfbl:0, hfg:0,ease:"Power3.easeInOut"},
		{showsize:"half",fs:17, fw:"500", ff:"Roboto", lh:40, pd:["0px","25px","0px","25px"],  bg:"#007aff",  color:"#ffffff", br:["25px", "25px", "25px", "25px"], content:"Click Here", cls:"rev-btn", hs:300, hc:"#ffffff", hbg:"#007aff", hfb:"120%", hfbl:0, hfg:0,ease:"Power3.easeInOut"},

		{fs:18, fw:"500", ff:"Roboto", lh:50, pd:["0px","40px","0px","40px"],  bg:"#007aff", br:["3px", "3px", "3px", "3px"], color:"#ffffff", content:"Click Here", cls:"rev-btn", hs:100, hc:"#ffffff", hbg:"#007aff", hfb:"120%", hfbl:0, hfg:0,ease:"Power1.easeInOut"},
		{fs:20, fw:"500", ff:"Roboto", lh:55, pd:["0px","50px","0px","50px"],  bg:"#007aff", br:["3px", "3px", "3px", "3px"], color:"#ffffff", content:"Click Here", cls:"rev-btn", hs:100, hc:"#ffffff", hbg:"#007aff", hfb:"120%", hfbl:0, hfg:0,ease:"Power1.easeInOut"},
...
(function() {
	...
	RVS.F.showQuickStyle = function() {
		...
		punchgs.TweenLite.to('#quick_style',0.4,{width:320,display:"block", ease:punchgs.Power3.EaseInOut});
		punchgs.TweenLite.to('#quick_style_inner',0.4,{left:0, ease:punchgs.Power3.EaseInOut});
	...
	RVS.F.closeQuickStyle = function() {
		...
		punchgs.TweenLite.to('#quick_style',0.4,{width:0,display:"none", ease:punchgs.Power3.EaseInOut});
		punchgs.TweenLite.to('#quick_style_inner',0.4,{left:-270, ease:punchgs.Power3.EaseInOut});
	...
	****************************/
	...
	function setContentColor(th,c) {
		...
		punchgs.TweenLite.to(cont.find('.quick_style_example_content'),0.2,{color:RVS.LIB.QS[th[0].dataset.cont+'_color']});
		punchgs.TweenLite.to(cont.find('.quick_style_example_wrap'),0.2,{backgroundColor:c==='dark' ? '#fff' : '#202224'});
	...
	function initLocalListeners() {
		...
		RVS.DOC.on('click','.quick_style_menu_point',function() {
			...
			punchgs.TweenLite.to(o,0.6,{val:res, onUpdate:function() {
		...
		RVS.DOC.on('mouseenter','.quick_style_example_content', function() {
			if (this.dataset.hoverspeed!==undefined) {
				...
				if (j.data('hoveranim')===undefined) {
					var ntl = new punchgs.TimelineLite(),
					...
					if (this.dataset.filterbrightness!==undefined && this.dataset.filterbrightness!=='undefined') {
						...
						punchgs.TweenLite.set(this,{filter:'blur(0px) grayscale(0%) brightness(100%)', '-webkit-filter':'blur(0px) grayscale(0%) brightness(100%)'});
					}
					if (this.dataset.ease!==undefined) animto.ease = this.dataset.ease;
					ntl.add(punchgs.TweenLite.to(this,this.dataset.hoverspeed/1000,animto));

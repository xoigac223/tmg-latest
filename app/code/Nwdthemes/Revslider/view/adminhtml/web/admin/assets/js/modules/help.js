...
;jQuery(function() {
	...
	trigger = jQuery('.help_wrap').on('click', function(e) {
		...
		// verify globals
		if(typeof RVS.ENV.plugin_url === 'undefined' || typeof RVS === 'undefined' || typeof punchgs === 'undefined') return;
	...
	function onOffHelp() {
		...
		if(!helpActive) {
			...
			punchgs.TweenMax.set(helper, {top: 50, left: 'auto', right: '100%', bottom: 'auto', height: 'auto'});

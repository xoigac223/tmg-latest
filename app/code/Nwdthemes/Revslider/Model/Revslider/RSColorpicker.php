...
namespace Nwdthemes\Revslider\Model\Revslider;
	...
	class RSColorpicker {
		...
		*/
		 ...
		 * @since 5.3.2
		 */
		public static function save_color_presets(
			\Nwdthemes\Revslider\Helper\Framework $frameworkHelper,
			$presets
		){
			$frameworkHelper->update_option('tp_colorpicker_presets', $presets);
			return self::get_color_presets($frameworkHelper);
		}
		...
		public static function get_color_presets(
			...
			return $frameworkHelper->get_option('tp_colorpicker_presets', array());
		}

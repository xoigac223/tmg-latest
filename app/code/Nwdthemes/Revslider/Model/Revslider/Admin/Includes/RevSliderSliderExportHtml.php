...
class RevSliderSliderExportHtml extends RevSliderSliderExport {
	...
	public function export_slider_html($slider_id){
		...
		if(version_compare($slider->get_param(array('settings', 'version')), $this->_frameworkHelper->get_option('revslider_update_revision', '6.0.0'), '<')){
	...
	public function replace_export_html_urls(){
		...
		if($this->export_real){ //only include if real export
			...
			if(!$this->usepcl){
				...
				$this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/revolution.tools.min.js', 'js/revolution.tools.min.js');
                ...
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/GreensockBase.js', 'js/GreensockBase.js');
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/TouchSwipe.js', 'js/TouchSwipe.js');
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/punchgs.js', 'js/punchgs.js');
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/TweenMax.js', 'js/TweenMax.js');
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/TweenMax.js', 'js/TweenMax.js');
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/easing/CustomBounce.js', 'js/CustomBounce.js');
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/easing/CustomEase.js', 'js/CustomEase.js');
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/easing/CustomWiggle.js', 'js/CustomWiggle.js');
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/SplitText.js', 'js/SplitText.js');
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/waitForImages.js', 'js/waitForImages.js');
                $this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/tools/vimeo.player.min.js', 'js/vimeo.player.min.js');
				...
				$this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/revolution.tools.min.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/', PCLZIP_OPT_ADD_PATH, 'js/');
                ...
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/GreensockBase.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/', PCLZIP_OPT_ADD_PATH, 'js/');
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/TouchSwipe.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/', PCLZIP_OPT_ADD_PATH, 'js/');
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/punchgs.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/', PCLZIP_OPT_ADD_PATH, 'js/');
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/TweenMax.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/', PCLZIP_OPT_ADD_PATH, 'js/');
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/TweenMax.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/', PCLZIP_OPT_ADD_PATH, 'js/');
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/easing/CustomBounce.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/easing/', PCLZIP_OPT_ADD_PATH, 'js/');
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/easing/CustomEase.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/easing/', PCLZIP_OPT_ADD_PATH, 'js/');
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/easing/CustomWiggle.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/easing/', PCLZIP_OPT_ADD_PATH, 'js/');
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/SplitText.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/', PCLZIP_OPT_ADD_PATH, 'js/');
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/waitForImages.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/', PCLZIP_OPT_ADD_PATH, 'js/');
                $this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/vimeo.player.min.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/tools/', PCLZIP_OPT_ADD_PATH, 'js/');

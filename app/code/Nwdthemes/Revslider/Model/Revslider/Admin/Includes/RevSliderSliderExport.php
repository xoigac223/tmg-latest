...
class RevSliderSliderExport extends RevSliderSlider {
	...
	public function export_slider($id = 0){
		...
		if(version_compare($this->get_param(array('settings', 'version')), $this->_frameworkHelper->get_option('revslider_update_revision', '6.0.0'), '<')){
	...
	public function add_svg_to_zip(){
		if(!empty($this->used_svg)){
			$content_url	= $this->_frameworkHelper->content_url();

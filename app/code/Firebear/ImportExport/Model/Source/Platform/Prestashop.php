...
class Prestashop extends AbstractPlatform
{
    ...
    {
        return parent::mergeData($rowData, $prevData, $separator); // TODO: Change the autogenerated stub
    }
            ...
            if (isset($this->productCombinations[$id])) {
                ...
                if (\is_array($combination)) {
                    ...
                    if (isset($combination['associations']['product_option_values']['product_option_value'])) {
                        foreach ($combination['associations']['product_option_values']['product_option_value'] as $product_option_value) {
                    ...
                    if (isset($combination['associations']['images']['image'])) {
                        ...
                        foreach ($combination['associations']['images']['image'] as $image) {
                            ...
                            if (isset($image['id'])) {
                                $images[] = $this->apiURL . '/' . $endPoint . '/' . $combination['id_product'] . '/' . $image['id'];
                            }
                        }
                    }
                    if (!empty($images)) {

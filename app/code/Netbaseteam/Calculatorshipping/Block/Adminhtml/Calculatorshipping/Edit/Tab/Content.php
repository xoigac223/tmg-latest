...
/**
 * calculatorshipping edit form main tab
 */
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Netbaseteam\CalculatorshippingModel\Calculatorshipping */
        ...
        $form->setHtmlIdPrefix('calculatorshipping_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_calculatorshipping_edit_tab_content_prepare_form', ['form' => $form]);

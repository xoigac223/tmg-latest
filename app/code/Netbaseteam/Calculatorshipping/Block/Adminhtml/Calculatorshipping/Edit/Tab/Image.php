    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'calculatorshipping_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_calculatorshipping_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Netbaseteam\Calculatorshipping\Block\Adminhtml\Form\Element\Image'];
    }
}

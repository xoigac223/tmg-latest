    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if (!$this->dataProcessor->validate($data)) {
                $this->_redirect('*/*/edit', ['calculatorshipping_id' => $model->getId(), '_current' => true]);
                return;
            }

            try {
                $imageHelper = $this->_objectManager->get('Netbaseteam\Calculatorshipping\Helper\Data');
            ...
            $this->_redirect('*/*/edit', ['calculatorshipping_id' => $this->getRequest()->getParam('calculatorshipping_id')]);
            return;
        }
        $this->_redirect('*/*/');
    }

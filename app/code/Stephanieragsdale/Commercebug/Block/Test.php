...
* All rights reserved
*/
namespace Stephanieragsdale\Commercebug\Block;
use Magento\Framework\View\Element\BlockInterface;
use Magento\Framework\View\Element\AbstractBlock;
use Magento\Framework\View\Element\Template;
use Stephanieragsdale\Commercebug\Model\ViewVars;
use ReflectionClass;
class Test extends Template //AbstractBlock
{
    ...
    {
        $lookup = $this->viewVars->getData('class_to_lookup_name');
        $r = new ReflectionClass($lookup);

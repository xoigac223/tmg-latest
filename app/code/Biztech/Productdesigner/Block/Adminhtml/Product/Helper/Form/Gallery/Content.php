...
namespace Biztech\Productdesigner\Block\Adminhtml\Product\Helper\Form\Gallery;
...
class Content extends \Magento\Backend\Block\Widget
{
    ...
    protected $_template = 'Biztech/Productdesigner/gallery.phtml';
  ...
  protected $_mediaConfig;
    ...
    {
            $_template = $this->_objectManager->create('Magento\Framework\View\Element\Template');                                   

...
class Save extends \Biztech\Productdesigner\Controller\Adminhtml\Pcolor
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('productdesigner/pcolor/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('productdesigner/pcolor/edit', ['id' => $id]);
                } else {
                    $this->_redirect('productdesigner/pcolor/new');
                }
                return;
            } catch (\Exception $e) {

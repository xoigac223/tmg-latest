...
define([
    ...
    $.widget('mage.productGallery', {
        ...
        // console.log(imageData);
            imageData = $.extend({
                ...
                'is_imprintdefaultlocation': imageData.is_imprintdefaultlocation ? imageData.is_imprintdefaultlocation : 0,
                'position': count + 1,
    ...
    $.widget('mage.productGallery', $.mage.productGallery, {
        ...
        _initDialog: function () {
            ...
            $dialog.on('change', '[data-role=imprint-visibility-trigger]', $.proxy(function (e) {
                var imageData = $dialog.data('imageData');
                this.element.trigger('updateVisibility', {
                    is_imprintdefaultlocation: $(e.currentTarget).is(':checked'),
                    imageData: imageData
                })
            }, this));            

		...
		this.options = Object.extend(
			{
				 ...
				 */
				onEndSelection: Prototype.emptyFunction,
				/**
				 * @var boolean
				 ...
				 */
				autoIncludeCSS: true,
                /* Design ID and relative key for multiple area selection
                * Added by BC: NT 09-06-2015
                * starts
                */
                designId: 0,
                designKey: 0,
	...
	* Applies the supplied dimension restriction to the supplied coordinates along a single axis
	...
	endCrop : function() {
		...
		this.options.onEndSelection(
            ...
            * starts
            */
            this.options.designId,
            this.options.designKey
            /* ends */
		);
	},

    ...
    $.widget('bss.infinite_scroll', {
        ...
        _intConfig: function () {
            ...
            if (options.jsonConfig.general.use_previous) {
                ias.extension(new IASHistoryExtension({prev: options.classes.prev}));
            }
            config.offset = 9999;
            ...
            if (Object.keys(config).length > 1) {
                ias.extension(new IASTriggerExtension(config));
            }
            ...
            if (options.jsonConfig.button.text_end_load) {
                ias.extension(new IASNoneLeftExtension({text: options.jsonConfig.button.text_end_load}));
            }

...
window.DynamicProductOptions = {
    ...
    prepareOptions : function() {
        ...
        this.getPriceBox().on('updatePrice', function(ev, prices){
            ...
            if (!obj.taxInfo.priceAlreadyIncludesTax && obj.taxInfo.displayPriceMode == 1) obj.taxRate = 1;
...
window.removeDDPrices = function(){
    if (!jQuery.mage.priceOptions) setTimeout(function(){window.removeDDPrices()}, 200); else {
        jQuery('#itoris_dynamicproductoptions select').each(function(a, s){
            jQuery.each(s.options, function(i, o){ if (o.origTitle) o.innerText = o.origTitle; });
        });
    }

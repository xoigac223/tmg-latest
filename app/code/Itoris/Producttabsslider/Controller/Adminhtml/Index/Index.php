...
namespace Itoris\Producttabsslider\Controller\Adminhtml\Index;
...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Tabs'), __('Tabs'));
        $resultPage->addBreadcrumb(__('Manage Tabs'), __('Manage Tabs'));
